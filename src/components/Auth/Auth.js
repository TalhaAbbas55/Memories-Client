...
const Auth = () => {
  ...
  useEffect(() => {
    function start() {
      gapi.client.init({
        clientId:
          "1006668345860-v8glfp06clmokqu7e4k6t3tbcttp1v8s.apps.googleusercontent.com",
        scope: "email",
      });
    }
    ...
    <Container component="main" maxWidth="xs">
      <Paper className={classes.paper} elevation={3}>
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
          ...
          <GoogleLogin
            clientId="1006668345860-v8glfp06clmokqu7e4k6t3tbcttp1v8s.apps.googleusercontent.com"
            render={(renderProps) => (
              <Button
